 ...
 * @updateUrl https://raw.githubusercontent.com/thunderstorm010/ShowHiddenChannels/main/0BDFDB.plugin.js
 */
		...
		load () {
			...
			const requestLibraryData = tryAgain => {
				const parseCSS = css => {
					...
					else request.get(`https://github.com/thunderstorm010/ShowHiddenChannels/tree/main/_res/${dataFileName}`, (e, r, b) => {
