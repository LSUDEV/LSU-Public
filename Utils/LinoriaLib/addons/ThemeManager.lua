...
local ThemeManager = {} do
	...
	function ThemeManager:CreateThemeManager(groupbox)
        ...
        task.spawn(function()
            while game:GetService('RunService').RenderStepped:Wait() do
                if Toggles['Rainbow Accent Color'].Value then
                    local Registry = self.Library.Holder.Visible and self.Library.Registry or self.Library.HudRegistry;
		...
		groupbox:AddDropdown('ThemeManager_ThemeList', { Text = 'Selected Theme', Values = ThemesArray, Default = 1 })
